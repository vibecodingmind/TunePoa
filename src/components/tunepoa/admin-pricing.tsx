...
const DURATION_COLUMNS = [
 { key: '1', label: '1 Month', field: 'price1Month' as const, color: 'from-tp-500/10 to-ts-500/10 from-tp-500/20 to-ts-500/20' },
 { key: '3', label: '3 Months', field: 'price3Month' as const, color: 'from-tp-500/10 to-cyan-500/10 from-tp-500/20 to-cyan-500/20' },
 { key: '6', label: '6 Months', field: 'price6Month' as const, color: 'from-tp-500/10 to-sky-500/10 from-tp-500/20 to-sky-500/20' },
 { key: '12', label: '12 Months', field: 'price12Month' as const, color: 'from-tp-500/10 to-violet-500/10 from-tp-500/20 to-violet-500/20' },
] as const
...
function EditablePriceCell({
 ...
 <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-xs text-slate-400 font-medium pointer-events-none">
 TZS
 </span>
 <input
 ref={inputRef}
 ...
 'rounded-lg',
 'outline-none',
 'shadow-[0_0_0_3px_rgba(52,211,153,0.2)]',
 ...
 className="p-0.5 rounded hover:bg-tp-900/50 text-teal-400"
 aria-label="Confirm"
 >
...
function EditableTextCell({
 ...
 >
 <span className="inline-block group-hover:text-teal-400 group-hover:text-teal-400 transition-colors">
 {value || placeholder || '—'}
 </span>
 </button>
 )
...
function EditableMiniNumber({
 ...
 'bg-slate-800',
 'border-2 border-teal-400/30 rounded-md',
 ...
 'hover:text-teal-400 rounded px-1.5 py-0.5',
 'hover:bg-teal-500/10',
...
export function AdminPricing() {
 ...
 <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-teal-900/40">
 ...
 className="bg-amber-500/100 hover:bg-amber-600 text-white"
 >
 ...
 toast?.type === 'success'
 ? 'bg-tp-600 text-white bg-teal-500/100'
 : 'bg-red-600 text-white bg-red-500/100',
 )}
 role="alert"
 >
 {toast?.type === 'success' ? (
 ...
 <Card className="overflow-hidden border-white/[0.08]/60 shadow-sm">
 <CardHeader className="bg-white/5 border-b border-white/[0.08]/60 pb-4">
 <div className="flex items-center gap-2.5">
 <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-teal-900/40">
 ...
 {/* Tier Info Header */}
 <div className="px-4 py-3 border-b border-r border-white/[0.06] bg-slate-800/30">
 ...
 key={col.key}
 className={cn(
 'px-3 py-3 border-b border-r border-white/[0.06] text-center',
 'bg-gradient-to-br',
 col.color,
 )}
 >
 ...
 {/* Status Header */}
 <div className="hidden px-3 py-3 border-b border-r border-white/[0.06] bg-slate-800/30 text-center sm:block">
 <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
 Status
 </div>
 </div>
 {/* Actions Header */}
 <div className="hidden px-3 py-3 border-b border-white/[0.06] bg-slate-800/30 text-center sm:block">
 <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
 Actions
 </div>
 </div>
 ...
 <div
 className={cn(
 'flex flex-col justify-center gap-1.5 px-4 py-3.5 border-r border-white/[0.06]',
 ...
 <div
 key={col.key}
 className="flex items-center border-r border-white/[0.06] px-2 py-2"
 >
 <EditablePriceCell
 ...
 {/* Status */}
 <div className="hidden sm:flex items-center justify-center border-r border-white/[0.06] px-3 py-3">
 <div className="flex items-center gap-2">
 <Switch
 checked={tier.isActive}
 onCheckedChange={() => toggleTierActive(tier)}
 className={cn(
 'data-[state=checked]:bg-teal-500/100 data-[state=unchecked]:bg-white/[0.08]',
 )}
 ...
 isDirty
 ? 'text-teal-400 hover:text-teal-300 hover:bg-teal-500/10 text-teal-400 hover:bg-teal-500/10'
 : 'text-slate-400',
 )}
 >
 {isSaving ? (
 ...
 variant="ghost"
 onClick={addTier}
 className="w-full border-2 border-dashed border-white/[0.08] hover:border-teal-500/100 hover:bg-tp-950/20 text-slate-400 hover:text-teal-400 rounded-xl py-6 h-auto"
 >
 ...
 <Card className="border-white/[0.08]/60 shadow-sm">
 <CardHeader className="bg-white/5 border-b border-white/[0.08]/60 pb-4">
 <div className="flex items-center gap-2.5">
 <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-violet-900/40">
 ...
 'focus:border-teal-400/30',
 'focus:shadow-[0_0_0_3px_rgba(52,211,153,0.15)]',
 )}
 placeholder="0"
 ...
 <div className="group">
 <div className="flex items-center gap-2 mb-3">
 <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-amber-900/40">
 ...
 {/* ─── Info Card ────────────────────────────────────────────────────── */}
 <Card className="bg-slate-800/30 border-white/[0.08]/60">
