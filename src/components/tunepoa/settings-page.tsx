...
function getPasswordStrength(password: string): {
  ...
  switch (true) {
    case score <= 1:
      return { score: 20, label: 'Weak', color: 'bg-red-500', textColor: 'text-red-600' }
    case score === 2:
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Badge variant="outline" className="mt-2 text-xs border-slate-200 text-slate-500">
            ...
            <Card className="border-0 shadow-sm">
              ...
              <CardContent>
                <form onSubmit={handlePasswordChange} className="space-y-5">
                  ...
                  {/* Security note */}
                  <div className="flex items-start gap-2.5 rounded-xl bg-amber-50 border border-amber-100 p-4">
            ...
            <Card className="border-0 shadow-sm">
              <CardHeader>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg text-slate-900">Two-Factor Authentication</CardTitle>
