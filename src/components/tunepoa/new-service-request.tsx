    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-slate-500 text-sm mt-0.5">Create a new ringback tone ad for your business</p>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-11 ${errors.businessName ? 'border-red-400 focus:ring-red-200' : ''}`}
                />
                {errors.businessName && (
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      id="businessCategory"
                      className={`h-11 ${errors.businessCategory ? 'border-red-400' : ''}`}
                    >
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger
                      id="targetAudience"
                      className={`h-11 ${errors.targetAudience ? 'border-red-400' : ''}`}
                    >
          ...
          {(editSection === 'ad' || editSection === null) && (
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <Label className="text-slate-900 font-medium">Ad Type</Label>
              ...
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger
                    ...
                    className={`h-11 w-full sm:w-64 ${errors.preferredLanguage ? 'border-red-400' : ''}`}
                  >
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={6}
                  className={`resize-none text-sm leading-relaxed ${errors.adScript ? 'border-red-400' : ''}`}
                />
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 flex-1">
            ...
            <CardContent className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-slate-900 mt-0.5 font-medium">{form.businessName}</p>
                </div>
                <div>
                  <p className="text-xs text-slate-400 uppercase tracking-wider font-semibold">
                    Category
                  </p>
                  <p className="text-sm text-slate-900 mt-0.5 font-medium">{form.businessCategory}</p>
                </div>
                <div className="flex items-center gap-1.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-900 mt-0.5 font-medium">{form.targetAudience}</p>
                  </div>
                </div>
                <div className="flex items-center gap-1.5">
                  <Globe className="h-3.5 w-3.5 text-slate-400" />
                  <div>
                    ...
                    <p className="text-sm text-slate-900 mt-0.5 font-medium">{form.preferredLanguage}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-900 mt-0.5 font-medium">{selectedAdType?.label}</p>
                </div>
              </div>
        ...
        <Card className="border-0 shadow-sm bg-amber-50">
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-amber-800 text-sm">Pro Tips</h3>
